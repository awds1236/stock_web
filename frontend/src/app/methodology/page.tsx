...
export default function MethodologyPage() {
  return (
    <>
      ...
      <h3>분할 매수·매도 구간은 산술입니다</h3>
      <div className="card">
        <div>
          종목 화면의 분할 구간은 <strong>매매 신호가 아닙니다.</strong> 이미
          계산된 지지/저항 수준을 가격순으로 늘어놓고, 비중을 배분하고, 회차별
          누적 평균단가를 계산하는 산술입니다. 어느 가격에 사라거나 팔라고 말하지
          않습니다.
        </div>
        <ul style={{ marginTop: 8, paddingLeft: 18 }}>
          <li>
            <strong>근거가 약한 지표 위에 서 있습니다.</strong> 지지/저항은 이 앱에서
            학술 근거가 가장 약한 축이며, 뚫리면 의미가 반전됩니다. 분할로 나눈다고
            그 약함이 사라지지 않습니다.
          </li>
          <li>
            <strong>분할이 바꾸는 것은 하나뿐입니다.</strong> 한 가격에 전부 거는
            것보다 진입가의 분산이 줄어듭니다. 기대수익을 높이지 않으며, 하락이
            이어지면 더 많은 금액이 물립니다.
          </li>
          <li>
            <strong>수준이 모자라면 지어내지 않습니다.</strong> 그 방향의 지지/저항이
            3개가 안 되면 ATR(변동성) 등간격으로 채우고, 그 회차는 화면에서 다른
            배지로 표시합니다 — 근거의 종류가 다르면 화면에서도 달라야 합니다.
          </li>
          <li>
            <strong>비중 방식에 우열 근거는 없습니다.</strong> 균등과 뒤가중이
            평균단가를 어떻게 바꾸는지 보여줄 뿐입니다. 어느 쪽이 낫다는 검증을 이
            앱은 하지 않았습니다.
          </li>
        </ul>
      </div>
